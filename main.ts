...
// These blocks of code tell the computer to calculate the cost of the pizza using the diameter.
game.splash("Pizza Order")
let d = game.askForNumber("Enter diameter of the pizza(in). ")
let cost = 1.75 + 0.5 * d
let total_cost = cost * 1.13
let round = Math.round(total_cost * 100)
let final_round = round / 100
game.splash("The area of a pizza " + d + "in is $" + convertToText(final_round) + "(HST included).")
